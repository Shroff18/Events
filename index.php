...
<head>
    ...
    <style>
        ...
        #reviews {
            background: linear-gradient(-90deg, rgba(8, 32, 50, 0.8), rgba(8, 32, 50, 0.8)), url('images/review-back.jpg'), #082032;
        ...
        <div class="gallary_row">
            ...
            <div class="gallary_column">
                <div class="img-hover-zoom">
                    ...
                    <img src="images/13.jpg" style="width:100%" alt="">
                </div>
                <div class="img-hover-zoom">
                    <img src="images/h3.jpg" style="width:100%" alt="">
                </div>
                <div class="img-hover-zoom">
                    <img src="images/2.jpeg" style="width:100%" alt="">
                </div>
                <div class="img-hover-zoom">
                    <img src="images/g2.jpg" style="width:100%" alt="">
                </div>
