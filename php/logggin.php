            ...
            <div class="modal-content">
                ...
                <div class="forgot">
                    ...
                    <p class="create-acc">Don't have any account
                        <label for="show-Sigin-form" class="user-icon search-user" data-target="#create-modal" data-toggle="modal" data-dismiss="modal">create one<i class="fas fa-user"></i></label></a></p>
                    </div>
